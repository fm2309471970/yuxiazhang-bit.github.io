...
# Replace a conditional import with a hard-coded None so that find_extra does
...
# that is sensitive to the version of tornado, which could break find_extra
...
from find_extra._vendor.tenacity._asyncio import AsyncRetrying  # noqa:E402,I100

if tornado:
    from find_extra._vendor.tenacity.tornadoweb import TornadoRetrying
