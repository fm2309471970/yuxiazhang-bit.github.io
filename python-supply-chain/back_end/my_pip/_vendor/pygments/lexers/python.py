...
from my_pip._vendor.pygments.lexer import DelegatingLexer, Lexer, RegexLexer, include, \
    bygroups, using, default, words, combined, do_insertions, this, line_re
from my_pip._vendor.pygments.util import get_bool_opt, shebang_matches
from my_pip._vendor.pygments.token import Text, Comment, Operator, Keyword, Name, String, \
    Number, Punctuation, Generic, Other, Error, Whitespace
from my_pip._vendor.pygments import unistring as uni
