...
# Replace a conditional import with a hard-coded None so that my_pip does
...
# that is sensitive to the version of tornado, which could break my_pip
...
from my_pip._vendor.tenacity._asyncio import AsyncRetrying  # noqa:E402,I100

if tornado:
    from my_pip._vendor.tenacity.tornadoweb import TornadoRetrying
